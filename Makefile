...
check-file-io-roundtrip: $(TEST_FILE_IO_ROUNDTRIP_EXE)
	./$(TEST_FILE_IO_ROUNDTRIP_EXE)
...
check-memccpy: $(TEST_MEMCCPY_EXE)
	./$(TEST_MEMCCPY_EXE)
...
check-memmove: $(TEST_MEMMOVE_EXE)
	./$(TEST_MEMMOVE_EXE)
...
check-strcasecmp: $(TEST_STRCASECMP_EXE)
	./$(TEST_STRCASECMP_EXE)
...
check-strpbrk: $(TEST_STRPBRK_EXE)
	./$(TEST_STRPBRK_EXE)
