...
$(TEST_MEMMOVE_EXE): $(TEST_MEMMOVE_SRC) $(EHLIBC_SRC) $(HEADERS)
	gcc -o $(TEST_MEMMOVE_EXE) $(OUR_CFLAGS) $(TEST_MEMMOVE_SRC)

$(TEST_MEMSET_EXE): $(TEST_MEMSET_SRC) $(EHLIBC_SRC) $(HEADERS)
...
$(TEST_STRTOL_EXE): $(TEST_STRTOL_SRC) $(EHLIBC_SRC) $(HEADERS)
